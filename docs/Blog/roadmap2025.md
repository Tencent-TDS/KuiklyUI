...
::: info 存档说明
本文档为 Kuikly 2025 年开源规划的存档记录。鸿蒙、H5、微信小程序和社区组件市场等核心规划已落地；仍在推进的工具链方向以本文勾选状态为准。最新规划与进展请参见 [Kuikly Roadmap (2026)](./roadmap2026.md)。
:::
...
- [ ] 鸿蒙调试脚手架：持续推进中，最新进展见 [Kuikly Roadmap (2026)](./roadmap2026.md)。

## Compose DSL支持
除了已开源的自研DSL，我们也持续推进对标准Compose DSL的支持，并已在腾讯内部业务中落地验证。未来，我们将持续优化和完善，欢迎查看 [Kuikly Compose 概览](../Compose/overview.md) 了解更多详情。

## 社区组件：
`Kuikly`已经内置了30+业务UI组件（详见[组件API文档](../API/components/view.md)），满足了大部分业务的高频需求场景。但业务形态丰富多彩，我们深知需要建设更多的组件，以满足多样化需求。同时伴随鸿蒙跨端开发的适配，鸿蒙平台相关的支持也十分关键。
* [x] 社区组件平台：已推出，详见[社区组件市场](../Community/component_market.md)，欢迎开发者积极参与，共建共享丰富的社区组件。
